...
let channel = socket.channel("update:progress", {})
channel.join()
  .receive("ok", resp => { console.log("Joined the update channel successfully", resp) })
  .receive("error", resp => { console.log("Unable to join the update channel", resp) })
